...
import {resourceList} from "~/utils/data";
...
export default {
  ...
  async asyncData({params}) {
    ...
    const item = cloneDeep(resourceList.find(md => md.id === id));
    const html = (await import(`!!raw-loader!~/rebuild/resources/${id}.html`)).default;
    return {
      html,
      item
    }
