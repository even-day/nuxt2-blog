<template>
  <nav id="header" class="flex w100">
    ...
    <del/>
<!--    <input />-->
    <a class="home flex" v-if="openEdit.startsWith('https://')" target="_blank" href="https://github.com/even-day/nuxt2-blog" title="Go to Github">
    ...
    openEdit() {
      ...
      switch (paths[0]) {
        ...
        case 'resources':
          ...
          break;
        case 'about':
          return 'https://github.com/even-day/nuxt2-blog'
        default:
          return '/'
      }
      if (!paths[1]) {
